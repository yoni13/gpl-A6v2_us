...
//#ifndef CONFIG_AG71XX_CHECK_TX_STUCK
#define CONFIG_AG71XX_CHECK_TX_STUCK 1
//#endif
//#ifndef CONFIG_AG71XX_CHECK_RX_STUCK
//#define CONFIG_AG71XX_CHECK_RX_STUCK 1
//#endif
//#undef CONFIG_AG71XX_CHECK_RX_STUCK

#if defined(CONFIG_AG71XX_CHECK_TX_STUCK) || defined(CONFIG_AG71XX_CHECK_RX_STUCK)
#define CONFIG_AG71XX_CHECK_TXRX_STUCK	1
#endif

#ifdef CONFIG_AG71XX_CHECK_TXRX_STUCK
struct ag71xx_txrx_stuck {
#ifdef CONFIG_AG71XX_CHECK_RX_STUCK
	struct delayed_work work;
	uint32_t rx_pause;
	uint32_t rx_fcs_cnt;
	uint32_t rx_int_cnt;
	uint32_t prev_rx_int_cnt;
	uint32_t rx_packet;
	uint32_t mib_rx_packet;
#endif
#ifdef CONFIG_AG71XX_CHECK_TX_STUCK
	uint32_t tx_pause;
	uint32_t tx_pause_cnt;
#endif
};
#endif
...
#endif
#ifdef CONFIG_AG71XX_CHECK_TXRX_STUCK
	struct ag71xx_txrx_stuck txrx_stuck;
#endif
};
...
#define FIFO_CFG5_UC		BIT(17)	/* unknown */
