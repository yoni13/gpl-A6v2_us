...
static struct gpio_led apjet01_leds_gpio[] __initdata = {
	{
		.name		= "wifi_2g",
		.gpio		= TP_GPIO_LED_WLAN_2G,
		.active_low	= 1,
	},
	{
		.name		= "wifi_5g",
		.gpio		= TP_GPIO_LED_WLAN_5G,
		.active_low	= 0,
	},
	{
		.name		= "status",
		.gpio		= TP_GPIO_LED_STATUS,
		.active_low	= 1,
		.default_state = LEDS_GPIO_DEFSTATE_ON,
	},
	{
		.name		= "usb",
		.gpio		= TP_GPIO_LED_USB,
		.active_low	= 0,
	},
	{
		.name		= "wan_green",
		.gpio		= TP_GPIO_LED_WAN_GREEN,
		.active_low	= 1,
	},
	{
		.name		= "wan_orange",
		.gpio		= TP_GPIO_LED_WAN_ORANGE,
		.active_low	= 1,
	},
	{
		.name		= "wps",
		.gpio		= TP_GPIO_LED_WPS,
		.active_low	= 1,
	},
};
...
static void __init archer_a9v6_setup(void)
{
...
MIPS_MACHINE(ATH79_MACH_ARCHER_A9_V6, "APJET01", "TP-LINK Archer a9 v6 support",
	     archer_a9v6_setup);
