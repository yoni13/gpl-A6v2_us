...
void eth_initialize_mini(bd_t *bis)
{	
...
int eth_initialize_mini_stage2(bd_t *bis)
{
...
int abortboot_eth_initialize(bd_t *bis)
{
...
#if (CONFIG_COMMANDS & CFG_CMD_NET)
#if defined(CONFIG_NET_MULTI)
		puts ("Net: mini stage2   ");
#endif
		eth_initialize_mini_stage2(bis);
#endif
#endif
}
#endif
...
#if defined(CONFIG_FAST_BOOT)  && !defined(CFG_DOUBLE_BOOT_FACTORY)
#error TODO: 
#endif
